    ...
    while (1)
    {
        ...
        switch (*comando[0]) {
            ...
            case 'C':
                ...
                // Tamanho
                tamanho = tamX*((tamY*qtddCores)+stuffingBits);
            ...
            case 's':
                ...
                fwrite(&byte1, 1, 1, fp);               // 26 planos
                fwrite(&byte0, 1, 1, fp);               // 27 planos
                ...
                fwrite(&byte3, 1, 1, fp);               // 45 pixels/m na vertical
                
                fwrite("\0\0\0\0\0\0\0\0", 1, 8, fp);   // 46-53 restando até 53 bytes
